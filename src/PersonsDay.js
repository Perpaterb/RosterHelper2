...
function PersonsDay({index, dayName, shifts, staff, monday, group}) {
  ...
  useEffect(() => { 
    if(localStorage.getItem(monday.add(index, 'day').format('MM/DD/YYYY') + dayName + staff) != "undefined") {
  ...
  function setShift(selectedOption) {  //event.value
    ...
    if(selectedOption.value != undefined) {
      ...
      localStorage.setItem(monday.add(index, 'day').format('MM/DD/YYYY') + dayName + staff, JSON.stringify(selectedOption))
